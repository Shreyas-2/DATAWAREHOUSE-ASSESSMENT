...
(2, 'Praneeth', 21, 'Data Science'),
(3, 'Carlos', 20, 'Computer Science'),
(4, 'Divya', 24, 'Mathematics'),
(5, 'Elena', 18, 'Physics'),
(6, 'Farhan', 22, 'Computer Science'),
(7, 'Grace', 23, 'Undeclared'),
(8, 'Harsh', 20, 'Computer Science'),
(9, 'Irene', 21, 'Mathematics'),
(10, 'Jayden', 24, 'Computer Science'),
(11, 'Kiara', 22, 'Physics'),
(12, 'Shannu', 19, 'Data Science'),
(13, 'Maya', 23, 'Computer Science'),
(14, 'Neil', 17, 'Undeclared'),
...
-- Question: Which majors have more than 4 students, and what is the count for each?
...
SELECT Major, 
       GROUP_CONCAT(Name ORDER BY Name SEPARATOR ', ') AS Students
FROM Students
GROUP BY Major;
...
SELECT Major, ROUND(AvgAge) AS AvgAge
FROM (
    SELECT Major, AVG(Age) AS AvgAge
    FROM Students
    GROUP BY Major
) AS t;
